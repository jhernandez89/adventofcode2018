...
let sleepiestGaurd = findSleepiestGaurd(gaurdTimes)
let sleepiestMinute = findSleepiestMinute(gaurdTimes[sleepiestGaurd])

console.log('results: ',sleepiestMinute)